...
SIP_CROSS_COMPILE_ARGS=--target=$(CROSS_COMPILE) --host=$(CROSS_COMPILE) LDFLAGS='-lm' CFLAGS='-Wno-error=unused-label' LD=$(CC)
...
#Extra flags
OPENSSL_CROSS_COMPILE_ARGS_EXTRA=unset CROSS_COMPILE &&
