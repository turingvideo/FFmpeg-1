...
const AVOption ff_rtsp_options[] = {
    ...
    { "rtsp_scale", "set rtsp scale", OFFSET(rtsp_scale), AV_OPT_TYPE_FLOAT, {.dbl = 0.0 }, 0.0, 8.0, DEC},
    { "rtsp_speed", "set rtsp speed", OFFSET(rtsp_speed), AV_OPT_TYPE_FLOAT, {.dbl = 0.0 }, 0.0, 8.0, DEC},
    { "vivotek_rtsp_speed", "set vivotek rtsp speed", OFFSET(vivotek_rtsp_speed), AV_OPT_TYPE_FLOAT, {.dbl = 0.0 }, 0.0, 8.0, DEC},
